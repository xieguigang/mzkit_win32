namespace molmil {
  ...
  export class UI {
    ...
    meshOptionsFunction(payload, lv, mode) {
    ...
    deleteMeshFunction(payload, lv, mode) {
      if (!(payload instanceof Array)) payload = [payload];
    ...
    displayFunction(payload, lv, mode) {
      if (!(payload instanceof Array)) payload = [payload]
    ...
    popupMenuBuilder(title, fields, ondone, oncancel) {
    ...
    colorFunction(payload, lv, mode, setting) {
    ...
    buildComplexMenu(title, structure, previousCall, payload) {
    ...
    styleif_edmap(contentBox, callOptions) {
    ...
    styleif(showOption, callOptions) {
      var UI = this;
